...
Use " /heroName " to display the builds in short
Use " /heroName info" to display the builds in detail with a description
Use " /heroName counters" to display the counters for the given hero

If you think that typing is boring use /builds@hots_helper_bot to display a list of buttons

Use "/ct@hots_helper_bot" to enter in an intractive mode that helps you choose the best team during a ranked hero select
`
}
